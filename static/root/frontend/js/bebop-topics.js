    ...
    <div class="container content-container">
      ...
      <div v-else>
        ...
        <div class="topics-topic-top-buttons">
          ...
          <main role="main" class="ml-sm-auto col-md-12 pt-3" id="registerScreen">
        <h3 style="text-align: center">loginForm</h1>
            <hr/>
        <div class="login" style="margin-bottom:150px">
            ...
            <form id="loginForm">
              ...
              <a class="btn btn-block btn-primary" href="#" role="button" @click.prevent="$parent.signUp('email')">Sign Up</a>
              <a class="btn btn-block btn-primary" href="#" role="button" @click.prevent="$parent.signIn('email')">Sign In</a>
            </form>
            </div>
        </main>
          </div>
